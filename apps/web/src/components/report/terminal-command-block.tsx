...
export function TerminalCommandBlock({ title, lines }: TerminalCommandBlockProps) {
  return (
    <section className="panel-edge min-w-0 rounded-lg border border-devops-border bg-slate-950">
      ...
      <pre className="max-w-full overflow-x-auto p-5 font-mono text-sm leading-7 text-devops-text">
        {lines.map((line) => (
